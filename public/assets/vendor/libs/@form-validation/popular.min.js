            ...
            n = (function () {
                function e(e, t) {
                    (this.fields = {}),
                        ...
                        (this.filter = {
                            filters: {},
                            add: function (e, t) {
                                (this.filters[e] = this.filters[e] || []).push(
                                    t
                                );
                            },
                            clear: function () {
                ...
                return (
                    ...
                    (e.prototype.addField = function (e, t) {
                        ...
                        return (
                            (this.fields[e] = this.fields[e]
                                ? {
                                      selector:
                                          n.selector || this.fields[e].selector,
                    ...
                    (e.prototype.validateElement = function (e, t) {
                        ...
                        var i = this.elements[e];
                        if (
                            this.filter.execute("element-ignored", !1, [
                                e,
                                t,
                                i,
                            ])
                    ...
                    (e.prototype.executeValidator = function (e, t, n, i) {
                        var r = this,
                            o = this.elements[e],
                            a = this.filter.execute("validator-name", n, [
                                n,
                                e,
                            ]);
                        if (
                    ...
                    (e.prototype.getElementValue = function (e, t, n) {
                        ...
                        return this.filter.execute("field-value", i, [
                            i,
                            e,
                            t,
                            n,
                    ...
                    (n.prototype.parseOptions = function () {
                        ...
                        return (
                            ...
                            Object.keys(n).forEach(function (e) {
                                Object.keys(n[e].validators).forEach(function (
                                    t
                                ) {
                            ...
                            var a = this.messages.get(o),
                                s = a.querySelector(
                                    '[data-field="'
                                        ...
                                        .concat(
                                            e.validator.replace(/"/g, '\\"'),
                                            '"]'
                                        )
                                );
                            if (s || e.result.valid)
                                s && !e.result.valid
                                    ? ((s.innerHTML = this.getMessage(
                                          e.result
                                      )),
                                      this.core.emit(
                                          "plugins.message.displayed",
                                ...
                                this.containers.forEach(function (e, t) {
                                    ...
                                    d &&
                                        i(
                                            ...
                                            (n[this.opts.rowValidatingClass] =
                                                !1),
                    ...
                    validate: function (i) {
                        ...
                        return o.inclusive
                            ? {
                                  ...
                                  valid:
                                      parseFloat(r) >= a && parseFloat(r) <= s,
                              }
                            : {
                                  message: t(
                                      i.l10n
                                          ? o.message ||
                                                i.l10n.between.notInclusive
                                          : o.message,
                                      ["".concat(a), "".concat(s)]
                                  ),
                ...
                return {
                    validate: function (e) {
                        ...
                        switch (!0) {
                            ...
                            case !!N && !!j:
                                return {
                                    message: t(e.l10n ? e.l10n.date.range : s, [
                                        j,
                                        N,
                                    ]),
                                    meta: { date: F },
                        ...
                        return i.inclusive
                            ...
                            : {
                                  message: t(
                                      e.l10n
                                          ? i.message ||
                                                e.l10n.greaterThan.notInclusive
                                          : i.message,
                                      "".concat(r)
                                  ),
                                  valid: parseFloat(e.value) > r,
            ...
            (it.integer = function () {
                return {
                    validate: function (t) {
                        ...
                        return {
                            valid:
                                !isNaN(l) && isFinite(l) && Math.floor(l) === l,
                        };
                    },
                };
            }),
